<template>
  <div class="leave-review">
    ...
    <details class="all-reviews">
      <summary><h2>All Reviews</h2></summary>
      <div v-for="itemReviews in reviewsByItem" :key="itemReviews.itemId" class="item-reviews">
        <!-- Item Name as a Dropdown -->
        <details>
          <summary>{{ itemReviews.itemName }}</summary>
